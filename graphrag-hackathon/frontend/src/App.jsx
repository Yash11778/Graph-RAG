...
const DOMAIN_QUESTIONS = [
  {
    ...
    questions: [
      ...
      { question: 'What are the four freedoms of free software?', answer: 'The four freedoms are: freedom to run the program, freedom to study and change it, freedom to redistribute copies, and freedom to distribute modified versions.' },
      ...
      { question: 'What is copyleft?', answer: 'Copyleft is a licensing practice requiring derivative works to carry the same license as the original.' },
      { question: 'What is the GNU General Public License?', answer: 'The GNU General Public License is a free software license that guarantees users the freedom to use, study, share, and modify software.' },
      { question: 'Who founded the Free Software Foundation?', answer: 'Richard Stallman founded the Free Software Foundation in 1985 to promote free software.' },
      ...
      { question: 'What does copyleft require?', answer: 'Copyleft requires that derivative works be distributed under the same license as the original, preserving users\' freedoms.' },
      { question: 'What is the GNU project?', answer: 'The GNU project is a free software mass collaboration project initiated by Richard Stallman to develop a free Unix-like operating system.' },
      ...
      { question: 'What did Richard Stallman found?', answer: 'Richard Stallman founded the Free Software Foundation and launched the GNU project to create a free operating system.' },
      ...
      { question: 'How does copyleft differ from traditional copyright?', answer: 'Copyleft uses copyright law to require that all derivative works remain free, while traditional copyright restricts redistribution.' },
    ],
  },
  {
    domain: '🌍 World War II',
    questions: [
      ...
      { question: 'What was the atomic bomb used for in World War II?', answer: 'The atomic bomb was used against Japan to end World War II in the Pacific.' },
      ...
      { question: 'What caused World War II?', answer: 'World War II was caused by the aggressive expansion of Nazi Germany under Adolf Hitler, combined with the failure of appeasement policies.' },
      { question: 'What was Operation Overlord in World War II?', answer: 'Operation Overlord was the Allied invasion of Normandy, France, in June 1944, which opened a Western Front against Nazi Germany.' },
  ...
  },
  {
    ...
    questions: [
      ...
      { question: 'What was the Warsaw Pact?', answer: 'The Warsaw Pact was a collective defence treaty formed in 1955 by the Soviet Union and Eastern European countries as a counterpart to NATO.' },
      { question: 'How did the Cold War end?', answer: 'The Cold War ended with the dissolution of the Soviet Union in 1991, leaving the United States as the sole superpower.' },
    ],
  },
  {
    ...
    questions: [
      ...
      { question: 'What happened at the Battle of Aboukir Bay?', answer: 'The Battle of Aboukir Bay was a naval battle in 1798 where the British fleet under Nelson defeated the French fleet during Napoleon\'s Egypt campaign.' },
      ...
      { question: 'What was Napoleon\'s greatest achievement?', answer: 'Napoleon\'s greatest achievements include the Napoleonic Code legal system and the reorganisation of France and conquered European territories.' },
      ...
      { question: 'What was the Napoleonic Wars?', answer: 'The Napoleonic Wars were a series of conflicts between Napoleon Bonaparte\'s French Empire and various European coalitions from 1803 to 1815.' },
      ...
      { question: 'What was Julius Caesar\'s significance in history?', answer: 'Julius Caesar was a Roman military general and statesman who played a key role in transforming Rome from a republic toward an empire before his assassination in 44 BC.' },
      { question: 'What was Napoleon\'s defeat at Waterloo?', answer: 'Napoleon was decisively defeated at the Battle of Waterloo in 1815 by the Duke of Wellington, ending the Napoleonic Wars.' },
    ],
  },
  {
    ...
    questions: [
      ...
      { question: 'Where were atomic bombs dropped in World War II?', answer: 'Atomic bombs were dropped on the Japanese cities of Hiroshima on August 6, 1945, and Nagasaki on August 9, 1945.' },
      ...
      { question: 'What is antibiotic resistance?', answer: 'Antibiotic resistance occurs when bacteria evolve to withstand the effects of antibiotics like penicillin, making infections harder to treat.' },
      { question: 'What is nuclear fission?', answer: 'Nuclear fission is the process of splitting an atomic nucleus to release enormous amounts of energy, which is the principle behind atomic bombs and nuclear reactors.' },
      { question: 'Who was Alexander Fleming?', answer: 'Alexander Fleming was a Scottish scientist who discovered penicillin in 1928, revolutionising the treatment of bacterial infections.' },
      { question: 'What role did nuclear weapons play in ending World War II?', answer: 'Nuclear weapons dropped on Hiroshima and Nagasaki in August 1945 caused massive destruction and led directly to Japan\'s unconditional surrender.' },
    ],
  },
  {
    ...
    questions: [
      ...
      { question: 'What was Britain\'s role in the Cold War?', answer: 'Britain was a key Western ally during the Cold War, a founding member of NATO, and closely allied with the United States in opposing Soviet expansion.' },
    ],
  },
  {
    ...
    questions: [
      ...
      { question: 'How did the Vietnam War end?', answer: 'The Vietnam War ended in 1975 when North Vietnamese forces captured Saigon, leading to the reunification of Vietnam under communist rule.' },
      ...
      { question: 'What was the Battle of Stalingrad?', answer: 'The Battle of Stalingrad was a major World War II battle in which Soviet forces defeated the German army, marking a decisive turning point in the war.' },
      ...
      { question: 'What was the significance of the Battle of Midway?', answer: 'The Battle of Midway in 1942 was a decisive naval victory by the United States over Japan that shifted the balance of power in the Pacific.' },
      { question: 'What happened at the attack on Pearl Harbor?', answer: 'Japan launched a surprise attack on the US naval base at Pearl Harbor, Hawaii, on December 7, 1941, destroying much of the Pacific Fleet and bringing the US into World War II.' },
    ],
  },
];
