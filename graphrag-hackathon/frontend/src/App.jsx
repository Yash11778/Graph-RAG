...
const DOMAIN_QUESTIONS = [
  {
    ...
    questions: [
      ...
      { question: 'What is software?', answer: 'Software is a set of programs that runs on hardware, contrasted with the physical hardware of a computer.' },
  ...
  },
  {
    ...
    questions: [
      ...
      { question: 'What was the atomic bomb used for in World War II?', answer: 'The atomic bomb, developed by the Manhattan Project, was used against Japan to end World War II in the Pacific.' },
  ...
  {
    domain: '⚔️ Wars & Conflicts',
    questions: [
      { question: 'What was World War I?', answer: 'World War I was a global conflict from 1914 to 1918 between the Allied and Central powers, triggered by the assassination of Archduke Franz Ferdinand.' },
      { question: 'How did World War I differ from World War II?', answer: 'World War I was primarily a European war of trenches from 1914–1918, while World War II was a global conflict from 1939–1945 involving industrialised genocide and nuclear weapons.' },
      ...
      { question: 'What caused World War I?', answer: 'World War I was caused by a combination of militarism, alliance systems, imperialism, and the spark of Archduke Franz Ferdinand\'s assassination in 1914.' },
      { question: 'What was trench warfare in World War I?', answer: 'Trench warfare was the dominant form of fighting in World War I, where opposing armies dug lines of trenches facing each other, leading to years of stalemate.' },
