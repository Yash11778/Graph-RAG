...
/* ─── Domain questions — confirmed to return graph context from TigerGraph.
...
const DOMAIN_QUESTIONS = [
  {
    ...
    questions: [
      ...
      { question: 'What freedoms does free software give users?',
        answer: 'Free software gives users the freedom to run, copy, distribute, study, change, and improve the software.' },
      { question: 'What are the four freedoms of free software?',
        answer: 'The four freedoms are: freedom to run the program, freedom to study and change it, freedom to redistribute copies, and freedom to distribute modified versions.' },
      { question: 'What is the Free Software Foundation?',
        answer: 'The Free Software Foundation is a nonprofit organization that promotes the development and use of free software.' },
      { question: 'What is the difference between free software and open source software?',
        answer: 'Free software emphasizes users\' freedom while open source focuses on the development methodology, though they often refer to the same programs.' },
      { question: 'What is copyleft?',
        answer: 'Copyleft is a licensing practice that grants users the right to use, modify, and distribute software, requiring derivative works to carry the same rights.' },
      { question: 'What is the GNU General Public License?',
        answer: 'The GNU General Public License is a free software license that guarantees users the freedom to use, study, share, and modify software.' },
      { question: 'What is the GNU project?',
        answer: 'The GNU project is a free software mass collaboration project initiated by Richard Stallman to develop a free Unix-like operating system.' },
      { question: 'Who founded the Free Software Foundation?',
        answer: 'Richard Stallman founded the Free Software Foundation in 1985 to promote free software.' },
      ...
      { question: 'What is the Linux kernel?',
        answer: 'The Linux kernel is a free and open-source Unix-like operating system kernel created by Linus Torvalds in 1991.' },
      { question: 'What is the difference between free software and proprietary software?',
        answer: 'Free software grants users four essential freedoms, while proprietary software restricts users from viewing, modifying, or distributing the source code.' },
      { question: 'What is a software license?',
        answer: 'A software license is a legal instrument governing the use and redistribution of software.' },
      { question: 'What does copyleft require?',
        answer: 'Copyleft requires that derivative works be distributed under the same license as the original, preserving users\' freedoms.' },
      { question: 'What is the GPL license?',
        answer: 'The GPL (GNU General Public License) is a widely-used free software license that ensures end users the freedom to run, study, share, and modify the software.' },
    ],
  },
  {
    domain: '🖥️ Software & Computing',
    questions: [
      ...
      { question: 'What is the difference between software and hardware?',
        answer: 'Hardware is the physical components of a computer, while software is the set of programs and instructions that run on hardware.' },
      { question: 'What is an operating system?',
        answer: 'An operating system is system software that manages computer hardware, software resources, and provides services for computer programs.' },
      { question: 'What is application software?',
        answer: 'Application software is a program or group of programs designed for end users to perform specific tasks.' },
      { question: 'What is system software?',
        answer: 'System software manages and controls computer hardware so application software can perform tasks.' },
      { question: 'What is source code?',
        answer: 'Source code is the human-readable text written in a programming language that is compiled or interpreted to run as a program.' },
      { question: 'What is a computer program?',
        answer: 'A computer program is a collection of instructions that can be executed by a computer to perform a specific task.' },
      ...
      { question: 'What is Unix?',
        answer: 'Unix is a family of multitasking, multiuser computer operating systems originally developed at Bell Labs.' },
      { question: 'What is Linux?',
        answer: 'Linux is a family of open-source Unix-like operating systems based on the Linux kernel developed by Linus Torvalds.' },
      { question: 'What is the internet?',
        answer: 'The internet is a global system of interconnected computer networks that use the Internet protocol suite to communicate.' },
      { question: 'What is a compiler?',
        answer: 'A compiler is a program that translates source code written in one programming language into another language, typically machine code.' },
      { question: 'What is open source?',
        answer: 'Open source refers to software whose source code is made publicly available for anyone to view, modify, and distribute.' },
      { question: 'What is the difference between open source and proprietary software?',
        answer: 'Open source software makes its source code publicly available, while proprietary software keeps it closed and restricts redistribution.' },
      { question: 'What is a software bug?',
        answer: 'A software bug is an error, flaw, or fault in a computer program that causes it to produce incorrect or unexpected results.' },
    ],
  },
  {
    domain: '🏛️ Leaders & History',
    questions: [
      ...
      { question: 'Who was Nelson Mandela?',
        answer: 'Nelson Mandela was a South African anti-apartheid revolutionary and political leader.' },
      { question: 'What was the Roman Empire?',
        answer: 'The Roman Empire was an ancient state that controlled vast territories across Europe and the Mediterranean.' },
      { question: 'Who was Augustus?',
        answer: 'Augustus was the first emperor of the Roman Empire.' },
      { question: 'What was the Manhattan Project?',
        answer: 'The Manhattan Project was the US research effort during World War II that developed the first atomic bombs.' },
      { question: 'What is penicillin?',
        answer: 'Penicillin is a group of antibiotics used to treat bacterial infections, discovered by Alexander Fleming.' },
      { question: 'What is the United Nations?',
        answer: 'The United Nations is an international organization founded in 1945 to promote international peace and cooperation.' },
      { question: 'What was the Cold War?',
        answer: 'The Cold War was a period of geopolitical tension between the Soviet Union and the United States.' },
      { question: 'What was World War II?',
        answer: 'World War II was a global conflict between the Axis and Allied powers that lasted from 1939 to 1945.' },
    ],
  },
];
