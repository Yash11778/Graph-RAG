...
def load_questions() -> list[str]:
    ...
    with open(QA_FILE, encoding="utf-8") as f:
        for item in json.load(f):
            ...
            if q:
                qs.append(q)
    # A few extra broad phrasings users might type, so retrieval stays robust.
    qs += [
        "World War II", "World War I", "Cold War", "Napoleon Bonaparte",
        "Roman Empire", "free software", "Nelson Mandela", "Soviet Union",
        "Adolf Hitler", "Winston Churchill", "Manhattan Project", "NATO",
        "United Nations", "Augustus", "penicillin", "Vietnam War", "Korean War",
    ]
