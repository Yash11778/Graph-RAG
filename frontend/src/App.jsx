...
const DOMAIN_QUESTIONS = [
  {
    ...
    questions: [
      ...
      { question: 'What is copyleft?', answer: 'Copyleft is a licensing practice requiring derivative works to carry the same rights as the original.' },
  ...
  },
  {
    ...
    questions: [
      ...
      { question: 'What role did Japan play in World War II?', answer: 'Japan was one of the Axis powers in World War II.' },
      { question: 'What role did the United States play in World War II?', answer: 'The United States was one of the Allied powers in World War II.' },
      ...
      { question: 'What did the Manhattan Project develop?', answer: 'The Manhattan Project developed the first atomic bombs.' },
  ...
  {
    domain: '🥶 Cold War & Alliances',
    questions: [
      { question: 'What was the Cold War?', answer: 'The Cold War was a period of geopolitical tension between the Soviet Union and the United States.' },
      { question: 'Who fought in the Cold War?', answer: 'The Cold War was fought between the Soviet Union and the United States.' },
      ...
      { question: 'What is NATO?', answer: 'NATO is the North Atlantic Treaty Organization, a military alliance of North American and European countries.' },
      ...
      { question: 'What was the Korean War?', answer: 'The Korean War was a conflict between North Korea and South Korea from 1950 to 1953.' },
    ],
  },
  {
    domain: '🏛️ Leaders & Empires',
    questions: [
      { question: 'What was Napoleon Bonaparte known for?', answer: 'Napoleon Bonaparte was a French military and political leader.' },
      ...
      { question: 'Who was Nelson Mandela?', answer: 'Nelson Mandela was a South African anti-apartheid revolutionary and political leader.' },
      ...
      { question: 'Who was Augustus?', answer: 'Augustus was the first emperor of the Roman Empire.' },
      { question: 'Who was the first emperor of the Roman Empire?', answer: 'Augustus was the first emperor of the Roman Empire.' },
    ],
  },
];
